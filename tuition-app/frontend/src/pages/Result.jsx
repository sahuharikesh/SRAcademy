...
function PrintCardT1({ student, examRecords, cardRef }) {
  ...
  return (
    <div ref={cardRef} style={{ border: `2px solid ${gold}`, borderRadius: 10, overflow: 'hidden', background: '#fdf8ee' }}>
      <div style={{ background: 'linear-gradient(135deg,#0a0a0a 0%,var(--brand-dark, #1a1a1a) 50%,#0a0a0a 100%)', borderBottom: `3px solid ${gold}`, padding: '10px 20px', display: 'flex', alignItems: 'center' }}>
      ...
      <div style={{ padding: '8px 20px 16px', position: 'relative' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ marginTop: 12, background: 'linear-gradient(135deg,#0a0a0a,var(--brand-dark, #1a1a1a),#0a0a0a)', borderRadius: 8, padding: '10px 16px', display: 'flex', justifyContent: 'space-around', alignItems: 'center' }}>
