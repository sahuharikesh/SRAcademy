...
import { TeamOutlined, DollarOutlined, CheckCircleOutlined, CloseCircleOutlined, UsergroupAddOutlined } from '@ant-design/icons';
...
export default function StatsGrid({ stats, onNavigate }) {
  const cards = [
    ...
    { label: 'Total Groups',    value: stats?.totalGroups   ?? '...', variant: 'purple', icon: <UsergroupAddOutlined />,  to: '/groups'     },
  ...
  return (
    <div className="grid grid-cols-2 gap-2 mb-4 sm:gap-3 sm:mb-6 md:grid-cols-5">
      {cards.map((c, i) => (
